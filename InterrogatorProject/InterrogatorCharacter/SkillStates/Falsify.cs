...
namespace InterrogatorMod.Interrogator.SkillStates
{
    public class Falsify : BaseInterrogatorSkillState
    {
        ...
        public override void OnEnter()
        {
            ...
            PlayCrossfade("FullBody, Override", "Dash", "Dash.playbackRate", (dashDuration + dashDelay) * 1.5f, (dashDuration + dashDelay) * 0.05f);
        ...
        public override void FixedUpdate()
        {
            ...
            if (base.isAuthority && stopwatch >= dashDuration)
            {
